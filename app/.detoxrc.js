...
module.exports = {
  ...
  apps: {
    "ios.debug": {
      type: "ios.app",
      binaryPath:
        "ios/build/Build/Products/Debug-iphonesimulator/eativity-app.app",
      build:
        "xcodebuild -workspace ios/eativity-app.xcworkspace -scheme eativity-app -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build",
    },
    "ios.release": {
      type: "ios.app",
      binaryPath:
