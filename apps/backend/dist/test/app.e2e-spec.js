...
const weight_service_1 = require("../src/weight/weight.service");
...
describe("App e2e", () => {
    ...
    beforeAll(async () => {
        const moduleRef = await testing_1.Test.createTestingModule({
            ...
            providers: [prisma_service_1.PrismaService, weight_service_1.WeightService],
        }).compile();
    ...
    describe("User", () => {
        describe("Get user", () => {
            ...
            it("should get current user with the latest weight", async () => {
                ...
                jest
                    .spyOn(app.get(weight_service_1.WeightService), "getLatestWeight")
                    .mockResolvedValue({
                    id: 1,
                    userId: 0,
